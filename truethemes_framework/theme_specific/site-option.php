...
$body_bg_url =  get_template_directory_uri() . '/truethemes_framework/admin/images/body-backgrounds/';
...
$options[] = array( "name" => __('Meta Boxes','truethemes_localize'),
...
$options[] = array( "name" => __('Inline Editing','truethemes_localize'),
...
$options[] = array( "name" => __('Responsive Design','truethemes_localize'),
			"desc" => __('This theme comes with a Responsive Design that will adjust the theme\'s design when viewed on a mobile device. <em>Please check this box if you prefer to disable the responsive design.</em>','truethemes_localize'),
			"id" => $shortname."_responsive",
			"std" => "false",
			"type" => "checkbox");			
			
$options[] = array( "name" => __('Update Notifier','truethemes_localize'),
			"desc" => __('This functionality enables the theme to automatically check with our server, for the latest version available. <em>Please uncheck and disable this setting if you are experiencing slow loading in WordPress Admin</em>','truethemes_localize'),
...
$options[] = array( "name" => __('Blog Page','truethemes_localize'),
			"desc" => __('Select the page that you\'d like to use for the Blog.','truethemes_localize'),
...
$options[] = array( "name" => __('Banner Text','truethemes_localize'),
			"desc" => __('Enter the text to be displayed in the banner area the Blog page.','truethemes_localize'),
...
$options[] = array( "name" => __('Button Text','truethemes_localize'),
			"desc" => __('These buttons link to each full length Blog post.','truethemes_localize'),
			"id" => $shortname."_blogbutton",
			"std" => "Continue Reading &rarr;",
			"type" => "text");
			
$options[] = array( "name" => __('Drag-to-Share','truethemes_localize'),
					"desc" => __('Drag-to-share functionality is added to each blog post by default. <em>Un-check this box to disable this functionality.</em>','truethemes_localize'),
...
$options[] = array( "name" => __('Post Date and Comments','truethemes_localize'),
			"desc" => __('<em>Check this box</em> to disable the Post Date and Comment Count located next to each Blog Post.</em>','truethemes_localize'),
			"id" => $shortname."_post_date",
			"std" => "false",
			"type" => "checkbox");
			
$options[] = array( "name" => __('About-the-Author','truethemes_localize'),
			"desc" => __('The author\'s bio is displayed at the end of each Single Blog post. <em>Un-check this box to disable this functionality.</em><br /><br />Your Bio can be set within your Wordpress Profile page. <a href="profile.php">Users > Your Profile</a>','truethemes_localize'),
			"id" => $shortname."_blogauthor",
			"std" => "true",
			"type" => "checkbox");
			
$options[] = array( "name" => __('Related Posts','truethemes_localize'),
			"desc" => __('Related posts are displayed at the end of each blog post by default. <em>Un-check this box to disable this functionality.</em>','truethemes_localize'),
			"id" => $shortname."_related_posts",
			"std" => "true",
			"type" => "checkbox");
			
$options[] = array( "name" => __('Related Posts Title','truethemes_localize'),
			"desc" => __('Enter the title that is displayed above the list of related posts.<br /><br /><em>Simply ignore this section if you won\'t be displaying Recent Posts.</em>','truethemes_localize'),
			"id" => $shortname."_related_posts_title",
			"std" => "Related Posts",
			"type" => "text");
			
$options[] = array( "name" => __('Related Posts Count','truethemes_localize'),
			"desc" => __('Enter the amount of related posts you\'d like to display.<br /><br /><em>Simply ignore this section if you won\'t be displaying Recent Posts.</em>','truethemes_localize'),
...
$options[] = array( "name" => __('Default Avatar','truethemes_localize'),
			"desc" => __('This theme uses it\'s own custom avatar when users do not have a Gravatar account. <em>Un-check this box to enable WordPress default avatars instead. </em>','tt_theme_framework'),
			"id" => $shortname."_default_avatar",
			"std" => "true",
			"type" => "checkbox");
			
$options[] = array( "name" => __('Exclude Categories','truethemes_localize'),
			"desc" => __('Check off any Categories that you\'d like to exclude from the Blog.','truethemes_localize'),
...
$options[] = array( "name" => __('Styling and CSS','truethemes_localize'),
			"type" => "heading");
...
$options[] = array( "name" =>  __('Theme Designer','truethemes_localize'),
			"desc" => "",
			"id" => $shortname."_custom_info_text",
			"std" => __('You can further customize the entire look of your theme by using the built in Theme Designer. The Theme Designer is located right here within Site Options Panel under Appearance > Site Options > Theme Designer','truethemes_localize'),
			"type" => "info");
...
$options[] = array( "name" => __('Search Bar','truethemes_localize'),
			"desc" => __('A search bar is displayed within the Utility Panel by default. <em>Un-check this box to disable the search bar.</em>','truethemes_localize'),
...
$options[] = array( "name" => __('Breadcrumbs','truethemes_localize'),
			"desc" => __('Breadcrumbs are displayed within the Utility Panel by default. <em>Un-check this box to disable the breadcrumbs.</em>','truethemes_localize'),
...
$options[] = array( "name" => __('Theme Designer','truethemes_localize'),
			...
			$options[] = array( "name" => __('Boxed Layout','truethemes_localize'),
			"desc" => __('This theme\'s design spans the full width of the web browser by default. <em>Please check this box to switch to a fixed-width boxed layout.</em>','truethemes_localize'),
			"id" => $shortname."_boxedlayout",
			"std" => "false",
			"type" => "checkbox");		
			
$options[] = array( "name" => __('Boxed Layout - Drop Shadow','truethemes_localize'),
					"desc" => __('Set the opacity of the Boxed Layout drop shadow.<br /><br /><em>Values from: 0.1 - 1.0</em>','truethemes_localize'),
					"id" => $shortname."_boxedlayout_shadow",
					"std" => "0.5",
					"type" => "text");
					
$options[] = array( "name" =>  __('Body - Background Color','truethemes_localize'),
					"desc" => __('Select a custom background color for your website. <em>This setting is only recommended when using the boxed layout.</em>','truethemes_localize'),
					"id" => $shortname."_body_bg_color",
					"std" => "", 
					"type" => "color");
					
$options[] = array( "name" => __('Body - Background Image','truethemes_localize'),
			"desc" => __('Choose a custom background image for your website. <br /><br />You can also upload a custom background image using the setting below.<br /><br /><em>Background images are only recommended when using the boxed layout.</em>','truethemes_localize'),
...
$options[] = array( "name" => __('Body - Background Image Upload','truethemes_localize'),
			"desc" => __('Upload a custom background image for your website. <br /><br />Free backgrounds can be downloaded from <a href="http://www.subtlepatterns.com" target="_blank">www.subtlepatterns.com</a><br /><br /><em>Background images are only recommended when using the boxed layout.</em>','truethemes_localize'),
...
$options[] = array( "name" => __('Body - Background Image Position','truethemes_localize'),
			"desc" => __('Use this section to set the background position of your custom background image.<br /><br /><em>Background images are only recommended when using the boxed layout.</em>','truethemes_localize'),
...
$options[] = array( "name" => __('Body - Background Image Repeat','truethemes_localize'),
			"desc" => __('Use this section to set the repeat property for your custom background image.<br /><br /><em>Background images are only recommended when using the boxed layout.</em>','truethemes_localize'),
...
$options[] = array( "name" => __('WooCommerce','truethemes_localize'),
			"type" => "heading");
			
$options[] = array( "name" => __('Breadcrumbs','truethemes_localize'),
			"desc" => __('Breadcrumbs are displayed on the WooCommerce pages by default. <em>Un-check this box to disable this functionality.</em>','truethemes_localize'),
			"id" => $shortname."_woocommerce_breadcrumbs",
			"std" => "true",
			"type" => "checkbox");
			
$options[] = array( "name" => __('Search Bar','truethemes_localize'),
			"desc" => __('A Search bar is displayed on the WooCommerce pages by default. <em>Un-check this box to disable this functionality.</em>','truethemes_localize'),
			"id" => $shortname."_woocommerce_searchbar",
			"std" => "true",
			"type" => "checkbox");
			
$options[] = array( "name" => __('Banner Title','truethemes_localize'),
			"desc" => __('Set the page title that is displayed in the banner area of the WooCommerce Pages.','truethemes_localize'),
