...
$movie = get_template_directory_uri() . '/truethemes_framework/extended/3d-tag-cloud/tagcloud.swf';
$path = get_template_directory_uri() . '/truethemes_framework/extended/3d-tag-cloud/';
